...
import com.goanimal.util.BitmapUtil5;
 ...
 *
 */
public class GameServiceImpl5 implements GameService5{
	...
	public GameServiceImpl5(Context context, BeadBoard beadBoard) {
	...
	private void setPreparedBeads(){
		...
		for (int i = 0; i < Constant.PER_NUM; i++){
			Bead bead = BitmapUtil5.randomBead(context, beadBoard.scale);
	...
	private void init(){
		...
		for (int i = 0; i < Constant.INIT_NUM; i++){
			Bead temp = BitmapUtil5.randomBead(context, beadBoard.scale);
