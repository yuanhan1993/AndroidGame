...
import com.goanimal.util.BitmapUtil2;
import com.goanimal.util.Constant;
	 ...
	 * @version 1.0
	 */
	public  class GameServiceImpl2 implements GameService2 {
		/** Activity上下文 */
		...
		public GameServiceImpl2(Context context, BeadBoard beadBoard) {
		...
		private void setPreparedBeads(){
			...
			for (int i = 0; i < Constant.PER_NUM; i++){
				Bead bead = BitmapUtil2.randomBead(context, beadBoard.scale);
		...
		private void init(){
			...
			for (int i = 0; i < Constant.INIT_NUM; i++){
				Bead temp = BitmapUtil2.randomBead(context, beadBoard.scale);
