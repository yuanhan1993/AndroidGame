...
import com.goanimal.util.BitmapUtil4;
import com.goanimal.util.Constant;

public class GameServiceImpl4 implements GameService4{
		/** Activity上下文 */
		...
		public GameServiceImpl4(Context context, BeadBoard beadBoard) {
		...
		private void setPreparedBeads(){
			...
			for (int i = 0; i < Constant.PER_NUM; i++){
				Bead bead = BitmapUtil4.randomBead(context, beadBoard.scale);
		...
		private void init(){
			...
			for (int i = 0; i < Constant.INIT_NUM; i++){
				Bead temp = BitmapUtil4.randomBead(context, beadBoard.scale);
