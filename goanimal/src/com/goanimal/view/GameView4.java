...
public class GameView4 extends View{
	...
	public void draw(Canvas canvas) {
		...
		// 绘制下一轮要显示的三个珠子
		List<Bead> lists =  gameService4.getPreparedBeads();
		...
		for (int i = 0; i < beadBoard.beads.length; i++){
			for (int j = 0; j < beadBoard.beads.length; j++){
				...
				if (bead.getBitmap() != null){ // 绘制珠子
					// 获取可消珠子连接点
					List<Point> points = gameService4.getLinkPoints();
	...
	public void setGameService(GameService4 gameService4) {
		this.gameService4 = gameService4;
	}
